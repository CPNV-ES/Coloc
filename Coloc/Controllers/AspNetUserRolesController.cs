...
namespace Coloc.Controllers
{
    ...
    public class AspNetUserRolesController : Controller
    {
        ...
        public AspNetUserRolesController(ColocContext context)
        {
            _context = context;
        }
        ...
        {
            var colocContext = _context.AspNetUserRoles.Include(a => a.Role).Include(a => a.User);
        ...
        public async Task<IActionResult> Create([Bind("UserId,RoleId")] AspNetUserRoles aspNetUserRoles)
        {
            ...
            ViewData["RoleId"] = new SelectList(_context.AspNetRoles, "Id", "Id", aspNetUserRoles.RoleId); // First ID = 
