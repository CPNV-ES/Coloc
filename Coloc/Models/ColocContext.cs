...
{
    public partial class ColocContext : DbContext
    {
        public ColocContext()
        {
        }

        public ColocContext(DbContextOptions<ColocContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=localhost;Database=Coloc;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.Property(e => e.BeginTask).HasColumnType("datetime");
